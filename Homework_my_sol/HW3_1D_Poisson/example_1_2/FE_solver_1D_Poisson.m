function [solution,error] = FE_solver_1D_Poisson(x_domain,boundaryvalues,N,mesh_type,basis_type_trial,basis_type_test,coe_fun,load_fun,ref_fun,Gauss_type,der_s)
...
[A,b] = treat_Neumann_boundary(boundarynodes,boundaryvalues,coe_fun,N_basis,A,b,mesh_type);
