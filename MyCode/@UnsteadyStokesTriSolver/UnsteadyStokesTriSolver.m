classdef UnsteadyStokesTriSolver < handle
    ...
    methods
        function obj = UnsteadyStokesTriSolver(mesh,uTrialElement,uTestElement,pTrialElement,pTestElement,boundary,uTrial,uTest,pTrial,pTest,gauss,mu,g1,g2,bf1,bf2)
            obj.meshInfo = mesh;
